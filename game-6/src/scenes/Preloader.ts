...
// =====================================================================
// Preloader.ts — Asset-free bootstrap: bake the particle spark texture,
// hydrate the save profile, init audio, then enter the Menu.
// =====================================================================
...
export class Preloader extends Phaser.Scene {
  ...
  init(): void {
    try { SplashScreen.hide(); } catch { /* web */ }
    AudioManager.init();
  }
  ...
  preload(): void {
    ...
    GameState.hydrate()
      .then((p) => {
        AudioManager.setMusicVolume(p.musicVol ?? 0.5);
        AudioManager.setSfxVolume(p.sfxVol ?? 0.8);
